...
# Here Load packages
Packages <- c("tidyverse", "tidytext", "DT", "scales", "wordcloud2", "gridExtra", "ggplot2", "plyr", "dplyr", "d3heatmap")
...
![](../figs/Male_Word_Freq_Word_Cloud.png)![](../figs/Female_Word_Freq_Word_Cloud.png)
...
![](../figs/Married_Word_Freq_Word_Cloud.png)![](../figs/Single_Word_Freq_Word_Cloud.png)
...
![](../figs/Parenthood_Word_Freq_Word_Cloud.png)![](../figs/No_Parenthood_Word_Freq_Word_Cloud.png)
...
![](../figs/Gender_Group_Individual.png)![](../figs/Marital_Group_Individual.png)![](../figs/Parenthood_Group_Individual.png)
...
![](../figs/Gender_Heatmap.png)![](../figs/Marital_Heatmap.png)![](../figs/Parenthood_Heatmap.png)
...
![](../figs/VERB.png)![](../figs/NOUN.png)


According to the plot, we find that the verb which represent the stative has highest frequency which means that the moment which contain **stative** change are most likely bring the happy moment to people. And also the social verb or motion verb also are more likely to cause the happy moment. For noun, the **time** and **person** have high frequency which means that in a certain time a specific person will make people happy. Also we can find that the noun which represent **artifact**, **act**, **communication**, **food** and **group** also have very high frequency which means that the moment which have some **artifact**, **food**, **communication** are more likely to cause the happy moment.
